...
> ⛔ **기각 (2026-07-02 용준님)**: 통합배송솔루션 계약·API 자동화 프로젝트 폐기 — 재개 시 참조용으로만 보존. **한진 반출 엑셀 import(Phase B 일부)만 유효**. 정본 = `docs/superpowers/specs/2026-06-11-hanjin-courier-decision.md`
> 작성: 2026-05-11
