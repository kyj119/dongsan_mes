...
- **작성일**: 2026-07-02
- **상태**: ✅ **P1~P4 prod 완결 (2026-07-03)** — `cb4ad2b7` 배포 + 마이그 0438 적용(pragma n=1 검증). ※사고 이력: 코드가 0438보다 먼저 배포되어 주문 등록 500 발생(약 반나절) → 0438 단건 적용으로 복구. 교훈=마이그 동반 커밋은 push 즉시 remote 적용까지 한 단위로
