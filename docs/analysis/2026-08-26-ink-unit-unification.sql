...
-- ============================================================================
-- 남은 판단 (용준님)
--   · RM-I-TPM-*-18L 4품목 — 용준님은 「TPM은 5L·20L 두 가지」라 하셨다. 18L 은 별개 제품인지,
--     20L 의 옛 표기인지 확인 필요(재고 0 · 매입 각 1건 162,000원 = 9,000/L, 20L 은 10,000/L).
--   · RM-I0011~0014 「현수막 잉크」 4품목 — `specification='TPM-20L'` 이라 RM-I-TPM-*-20L 과 **중복 후보**.
--     재고 0 · 매입 0 · 단가 0 이라 휴면. 통합 또는 비활성 판단.
-- ============================================================================
