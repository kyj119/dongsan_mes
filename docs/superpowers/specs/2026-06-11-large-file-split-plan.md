...
- **작성일**: 2026-06-11
- **상태**: 🟢 **라우트 5대 완료, cards.js만 잔여** — 순서: ~~orders/core~~ ✅ → ~~taxInvoices~~ ✅ → ~~ledger/AR~~ ✅ → ~~purchaseOrders/core~~ ✅ → **cards.js·shell.js(클라 JS, `?raw` 다중 import 방식, 미착수)**. 파일별 경계는 착수 세션에서 심볼 맵 뜬 후 확정
