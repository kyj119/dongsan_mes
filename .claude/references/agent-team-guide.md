# 작업 위임 전략 가이드 (2026-06-05 개정 · 2026-07-02 모델 오버라이드 3단 · 2026-07-27 Opus 5 반영)
...
>   | **`model:"sonnet"`** | 판단 낮은 기계적 스테이지 — 전수 grep 스윕, 경로/명칭 치환, 표 정비, 정형 구현 | Explore fan-out 스윕, Workflow 기계적 변환 스테이지, 큐 단순 작업(frontmatter `model: sonnet`) |
