...
> **다음 액션**: ①B5 4대보험 7월요율 적용(**상한 637만→659만·하한 40만→41만** 리서치완료·prod insurance_rates 반영 확인대기) ②B3 직원셀프서비스 ③국민연금 기준소득월액 필드 ④단가. 출고v2 후속(선택)=P5 사진 증빙·토트 스캔(보류)·prod admin 기본비밀번호 강화(#336, owner 트리거 대기).
