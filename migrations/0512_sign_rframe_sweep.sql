...
-- #593: 7282(세이광고기획 1300x130cm)는 0509가 FRL→FRL-R로 내린 정정을 여기서 의도적으로 재승격.
--   0509의 근거는 판가 90k/㎡ 임계(45k/㎡→교체 가격대)였는데 0511 실물 역추적이 그 임계 자체를
--   반증했고(대형 신규 도매가 30~75k/㎡), 이 스윕의 실물 표본 10거래처에 세이광고기획이 포함돼
--   "후레임 제작+까치발" 신규 제작이 실물 확인됨. 0509의 단위(cm) 보정 자체는 유효 — 분류 결론만 교체.
