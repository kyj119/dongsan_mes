...
const ALLOWLIST = [
  ...
  // 카드 CSV import 중복체크(cardExpenses.ts): card_id로 스코프(카드=법인 종속, 직전 cardCheck가 법인 검증). 행별 SELECT를 80키 IN 청크로 접은 것(2026-09-09)
  'FROM card_transactions WHERE card_id = ? AND codef_transaction_id IN',
