...
const GATES = ['audit:empty-catch', 'audit:jsx-ternary', 'cut:bleed', 'cut:nest', 'cut:butt', 'cut:placement', 'cut:plate', 'cut:plate:baseline', 'cut:frame', 'cut:review', 'cut:smoke', 'cut:shellsync', 'panel:smoke', 'cut:e2e']
function runGates() {
