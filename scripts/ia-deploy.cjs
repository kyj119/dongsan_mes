...
// ⚠️`test:outcopy` 는 **은퇴했다**(2026-09-15, 하루 만에) — 그날 오전에 넣은 게이트인데, 같은 날 오후에
...
const GATES = ['audit:empty-catch', 'audit:jsx-ternary', 'audit:jsx-syntax', 'cut:bleed', 'cut:nest', 'cut:butt', 'cut:placement', 'cut:plate', 'cut:plate:baseline', 'cut:frame', 'cut:review', 'cut:trorder', 'cut:smoke', 'cut:shellsync', 'panel:smoke', 'cut:e2e']
function runGates() {
