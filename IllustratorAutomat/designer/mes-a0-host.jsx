      ...
      if (annotation) {
        ...
        for (var api = 0; api < apList.length; api++) {
          ...
          try {
            ...
            // ★밴드의 **15%** — 종전 50% 는 8cm 여백에서 글자 높이 4cm 가 되어 현수막 500x120 실물에서
            //   소비자 눈에 띄는 크기였다(2026-09-22 용준님 「방금 나온 것의 30% 정도」). 주석은 현장 식별용이지
            //   디자인이 아니다 — 읽히기만 하면 된다. 하한 6pt 는 그대로(안 읽히면 없느니만 못하다).
            var fsz = annBand * 0.15; if (fsz < 6) fsz = 6; if (fsz > 300) fsz = 300;
