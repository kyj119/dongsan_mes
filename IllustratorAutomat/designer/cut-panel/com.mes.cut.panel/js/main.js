...
(function () {
  ...
  // (CORNER 17mm + 지름 6mm). 어긋나면 조각이 돔보를 덮거나 시트를 넘는다.
  var DOMBO_MARGIN_MM = 23;
  ...
  function makeCut() {
    ...
    function runVectorCutWith(fv0) {
      out('벡터 칼선 만드는 중...');
      host('mesCut_vecCut(' + offsetMm + ',' + (fv0.fill ? 'true' : 'false') + ')', function (vc, badV) {
