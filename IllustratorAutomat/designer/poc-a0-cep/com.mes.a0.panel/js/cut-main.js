...
(function () {
  ...
  function startNumberArt(prep, res, info, mmpp, half) {
    ...
    function finish(note) {
      art.pending = false;
      if (elOut) elOut.textContent = String(elOut.textContent).replace(/\n  └ 고객용 번호 이미지[^\n]*/, '') + '\n번호 이미지 ' + note;
    }
