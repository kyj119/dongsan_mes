    ...
    function withList(list) {
      ...
      (function step() {
        ...
        readPng(it.path, function (err, img) {
          ...
          if (sq) squared++;
          var res = null;
          try { res = B.repeatLastPixel(src, gpx, sq ? { corner: 'square' } : undefined); } catch (e) { res = null; }
