  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    if (elBtnEnv && elEnvOut) elBtnEnv.addEventListener('click', function () {
      ...
      hostEval('typeof mesA0_envCheck === "function" ? mesA0_envCheck() : "na"', function (res, bad) {
        ...
        if (aiLow) bad2.push('일러 ' + e.ai + ' 는 등록 성공 실적이 없는 버전입니다 — 지금까지 등록 실패는 전부 이 버전 PC 에서 나왔고(잔해 9/11), '
          + AI_OK_FROM + ' 이상 PC 는 0/9 입니다. 업데이트 후 1건만 다시 돌려 보세요(그것으로 버전 탓인지 PC 탓인지 갈립니다)');
