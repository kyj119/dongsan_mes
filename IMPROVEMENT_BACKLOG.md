# Improvement Backlog
<!-- last_run_area: 4 -->
<!-- last_run_at: 2026-05-15T09:00:00+09:00 -->
...
> **Area 4 데이터 정합성 (2026-05-15T09:00):**
> - 7개 테이블 entity_id 인덱스 누락 (payment_requests/inventory_transactions/adjustments/purchase_payments/employees/hometax_jobs/portal_access_logs) → A-009 자동 수정 (0206 migration)
> - 대시보드 성능: orders/cards entity_id+status 복합 인덱스 누락 → A-009 포함 수정
> - employees 목록 entity_id 필터 없음 — 멀티사업자 환경 직원 혼재 → #57 등록 (MEDIUM, 30분)
> - hometax_jobs 목록 entity_id 필터 없음 — 법인별 세금계산서 작업 혼재 → #58 등록 (SMALL, 15분)
> - 자동 수정 1건 (A-009), 신규 이슈 2건 (#57/#58)
>
...
| I-025 | employees 목록 entity_id 필터 없음 — 멀티사업자 직원 혼재 | Area 4 | #57 | 30분 |
| I-026 | hometax_jobs 목록 entity_id 필터 없음 — 법인별 작업 혼재 | Area 4 | #58 | 15분 |
...
| ID | 제목 | 커밋 | 날짜 |
|----|------|------|------|
| A-009 | entity_id 인덱스 7개 테이블 + 대시보드 복합 인덱스 3개 (0206 migration) | — | 2026-05-15 |
