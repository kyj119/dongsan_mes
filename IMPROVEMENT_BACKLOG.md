# Improvement Backlog
<!-- last_run_area: 4 -->
<!-- last_run_at: 2026-05-18T00:00:00+09:00 -->
...
> **Area 4 데이터 정합성 (2026-05-18T00:00):**
> - 최근 마이그레이션(0213~0226) 스키마 전수 검토: entity_id/인덱스/상태 정합성/고아 레코드
> - entity_id 인덱스 누락 7개 (returns/purchase_invoices×3/fixed_assets/budgets/journal_entries) → A-009 자동 수정 (0227 migration)
> - returns.ts RESOLVED+RESTOCK inventory_transactions INSERT `balance_after NOT NULL` 오류 → #113 등록 (SMALL, 2h)
> - fixedAssets.post('/depreciate') entity_id 필터 없음 → #114 등록 (SMALL, 30m)
> - budgets.ts /vs-actual LABOR payroll entity_id 필터 누락 → #115 등록 (SMALL, 15m)
> - 자동 수정 1건 (A-009), 신규 이슈 3건 (#113~#115)
>
...
| I-025 | returns.ts RESTOCK 재고 복원 balance_after NOT NULL 오류 | Area 4 | #113 | 2h |
| I-026 | fixedAssets.post('/depreciate') entity_id 필터 없음 | Area 4 | #114 | 30분 |
| I-027 | budgets.ts /vs-actual LABOR payroll entity 필터 누락 | Area 4 | #115 | 15분 |
...
| ID | 제목 | 커밋 | 날짜 |
|----|------|------|------|
| A-009 | entity_id 인덱스 7개 추가 (returns/purchase_invoices×3/fixed_assets/budgets/journal_entries) | 0227 migration | 2026-05-18 |
