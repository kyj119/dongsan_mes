...
async function viewDetail(id) {
  try {
    ...
    document.getElementById('detailContent').innerHTML =
      ...
      + (inv.nts_approval_number ? '<div class="col-span-2"><span class="text-gray-500">국세청 승인번호:</span> <span class="font-mono text-green-700">' + inv.nts_approval_number + '</span></div>' : '')
