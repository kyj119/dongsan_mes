...
hrRouter.post('/employees', async (c) => {
  try {
    ...
    const ALLOWED = [
      ...
      'insurance_apply_industrial_accident', 'insurance_exempt_note', 'external_name',
