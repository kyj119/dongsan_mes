...
// 여기 있던 AP_MARGIN_RULES 는 finishing_methods.margin_cm 과 별개인 **제2의 마감 여백 정본**이었고,
// per-side JSON 을 문자열 includes 로 훑어 방향 정보를 뭉갰다. A0 패널이 이미 마감 여백을 적용한 뒤라
// 되살리면 이중 적용이 된다 — 부활 금지. 수동 진단 경로는 /api/auto-process(/ia-auto, ADMIN) 에 남아 있다.
