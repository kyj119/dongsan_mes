...
<p class="sec-cap" style="margin-top:14px">💡 <b>영업활동만으로 1.28억 현금 부족</b>(매출회수 &lt; 매입+인건비+운영비). 여기에 <b>공장이전 보증금·설비·쇼핑몰개발 등 자본지출 1.55억</b>가 겹쳐 대출·가수금 2.76억로 메꿨습니다. <b>인건비(급여+4대보험+복리 2.17억)</b>가 매입 다음 최대 유출. 미상 0.11억은 전기·보안·세무·등기 등 소액 운영비.</p>
</div><div class="sec">
