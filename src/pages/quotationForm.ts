            ...
            <div class="mb-6">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input type="text" maxlength="10" inputmode="numeric" placeholder="예: 2026-01-15" id="validUntil" required
                    class="js-fp w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500">
                </div>
              </div>
            </div>
