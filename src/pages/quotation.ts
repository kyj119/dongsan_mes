    ...
    <head>
        ...
        <style>
            ...
            * { margin: 0; padding: 0; box-sizing: border-box; }
            ...
            .email-modal input:focus { outline: none; border-color: var(--c-primary); box-shadow: 0 0 0 2px rgba(59,130,246,.2); }
    ...
    <body>
        ...
        <div class="email-modal-overlay" id="emailModalOverlay" onclick="if(event.target===this)closeEmailModal()">
            <div class="email-modal">
                <h3><i class="fas fa-envelope mr-2" style="color:var(--c-primary)"></i>이메일 발송</h3>
