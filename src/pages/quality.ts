  ...
  const pageContent = `
    <div class="ds-container space-y-4">
      ...
      <div id="qc-pane-claims" class="qc-pane space-y-3">
        <div class="ds-card p-3 flex flex-wrap items-end gap-3">
          <div>
            ...
            <select id="qcClaimStatus" onchange="window.qcLoadClaims()" class="border rounded px-2 py-1 text-xs" style="color:#212529;">
      ...
      <div id="qc-pane-returns" class="qc-pane space-y-3 hidden">
        <div class="ds-card p-3 flex flex-wrap items-end gap-3">
          <div>
            <label class="block text-[10px] text-gray-400 mb-1">상태</label>
            <select id="qcReturnStatus" onchange="window.qcLoadReturns()" class="border rounded px-2 py-1 text-xs" style="color:#212529;">
              <option value="">전체</option>
      ...
      <div class="bg-white rounded-lg shadow-xl w-full max-w-md p-4 space-y-3">
        ...
        <div>
          ...
          <div class="flex gap-2">
            <input id="qcClaimOrderSearch" class="flex-1 border rounded px-2 py-1 text-xs" placeholder="주문번호 또는 거래처명" style="color:#212529;" />
        ...
        <div class="grid grid-cols-2 gap-2">
          <div><label class="block text-[11px] text-gray-500 mb-1">유형</label>
            <select id="qcClaimType" class="w-full border rounded px-2 py-1 text-xs" style="color:#212529;">
          ...
          <div><label class="block text-[11px] text-gray-500 mb-1">청구액(원)</label><input id="qcClaimAmount" type="number" class="w-full border rounded px-2 py-1 text-xs" value="0" style="color:#212529;" /></div>
        </div>
        <div><label class="block text-[11px] text-gray-500 mb-1">내용</label><textarea id="qcClaimDesc" rows="3" class="w-full border rounded px-2 py-1 text-xs" style="color:#212529;"></textarea></div>
    ...
    <div id="qcResolveModal" class="fixed inset-0 bg-black/40 z-50 hidden items-center justify-center p-4" style="display:none;">
      <div class="bg-white rounded-lg shadow-xl w-full max-w-sm p-4 space-y-3">
        ...
        <div><label class="block text-[11px] text-gray-500 mb-1">처리방식</label>
          <select id="qcResolveType" class="w-full border rounded px-2 py-1 text-xs" style="color:#212529;">
        ...
        <div><label class="block text-[11px] text-gray-500 mb-1">확정 금액(원)</label><input id="qcResolveAmount" type="number" class="w-full border rounded px-2 py-1 text-xs" value="0" style="color:#212529;" /></div>
        <div class="flex justify-end gap-2 pt-1">
    ...
    <div id="qcDefectModal" class="fixed inset-0 bg-black/40 z-50 hidden items-center justify-center p-4" style="display:none;">
      <div class="bg-white rounded-lg shadow-xl w-full max-w-sm p-4 space-y-3">
        ...
        <div class="grid grid-cols-2 gap-2">
          <div><label class="block text-[11px] text-gray-500 mb-1">코드</label><input id="qcDefectCode" class="w-full border rounded px-2 py-1 text-xs" style="color:#212529;" /></div>
          <div><label class="block text-[11px] text-gray-500 mb-1">분류</label>
            <select id="qcDefectCategory" class="w-full border rounded px-2 py-1 text-xs" style="color:#212529;">
        ...
        <div><label class="block text-[11px] text-gray-500 mb-1">명칭</label><input id="qcDefectName" class="w-full border rounded px-2 py-1 text-xs" style="color:#212529;" /></div>
        <div><label class="block text-[11px] text-gray-500 mb-1">예방조치</label><input id="qcDefectPrevent" class="w-full border rounded px-2 py-1 text-xs" style="color:#212529;" /></div>
        <div class="flex justify-end gap-2 pt-1">
    ...
    <div id="qcReturnModal" class="fixed inset-0 bg-black/40 z-50 hidden items-center justify-center p-4" style="display:none;">
      <div class="bg-white rounded-lg shadow-xl w-full max-w-sm p-4 space-y-3">
        ...
        <div><label class="block text-[11px] text-gray-500 mb-1">다음 상태</label><select id="qcReturnNext" class="w-full border rounded px-2 py-1 text-xs" style="color:#212529;"></select></div>
        <div id="qcReturnResolveWrap" class="hidden space-y-2">
          <div><label class="block text-[11px] text-gray-500 mb-1">처리결과</label>
            <select id="qcReturnResolution" class="w-full border rounded px-2 py-1 text-xs" style="color:#212529;">
          ...
          <div><label class="block text-[11px] text-gray-500 mb-1">환불액(원)</label><input id="qcReturnRefund" type="number" class="w-full border rounded px-2 py-1 text-xs" value="0" style="color:#212529;" /></div>
